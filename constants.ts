...
// Configurações sincronizadas com o firebase-messaging-sw.js para garantir consistência.
...
// Chave VAPID real fornecida pelo usuário para permitir o registro de tokens FCM.
export const FIREBASE_VAPID_KEY = import.meta.env?.VITE_FIREBASE_VAPID_KEY || 'BG0qXrVsgHWYVprxOpHZ8qixMH-ijAiZuCCgx1B-B_4-WWvOb7GBY6ve8ImXvki2B7DtWSRM0HcWDj3TngQ';
